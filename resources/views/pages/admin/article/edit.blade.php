                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin-article-update', $article->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama" id="nama" class="form-control" placeholder="masukkan nama" value="{{ old('nama', $article->nama) }}">
                                        </div>

                                        <div class="form-group">
                                            <label for="alt">Alt</label>
                                            <input type="text" name="alt" id="alt" onclick="alter()" class="form-control" placeholder="masukkan alt" value="{{ old('alt', $article->alt) }}">
                                            <p id="alter" class="text-muted alter" ></p>
                                        </div>

                                        <div class="form-group">
                                            <label for="meta">Meta</label>
                                            <input type="text" name="meta" id="meta" onclick="metadata()" class="form-control" placeholder="masukkan meta" value="{{ old('meta', $article->meta) }}">
                                            <p id="metadata" class="text-muted metadata" ></p>
                                        </div>

                                        <div class="form-group">
                                            <label for="tanggal_buat">Tanggal buat</label>
                                            <input type="text" name="tanggal_buat" id="datepicker" class="form-control" placeholder="masukkan tanggal" value="{{ old('tanggal_buat', $article->tanggal_buat) }}">
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            rows="5" placeholder="Masukkan Konten Blog">{!! old('deskripsi', $article->deskripsi) !!}</textarea>
                                        </div>

                                         <div class="form-group">
                                            <label for="gambar" class="form-label">Gambar</label>
                                            <input type="hidden" name="oldImage" id="" value="{{ $article->gambar }}">
                                            <input type="file"
                                                id="gambar"
                                                name="gambar"
                                                class="form-control"
                                            ...
                                            @if ($article->gambar)
                                                <img src="{{ Storage::url($article->gambar) }}" style="width:150px" class="img-preview img-fluid" alt="">
                                            @else
