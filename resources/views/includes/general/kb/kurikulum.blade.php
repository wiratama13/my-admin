            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading text-center mb-100 wow fadeInUp" data-wow-delay="100ms">
                        <div class="line"></div>
                        <h3 style="color: #CC0066;">Kurikulum KB</h3>
                    </div>
                </div>
            </div>
        </div>
             ...
             <div class="row">
                <div class="col-12 col-sm-80">
                    <div class="single-team-member-area mb-100">
                          ...
                          <div class="paragraf" style="text-align: justify; color:#003366;">Kurikulum KB Al Muslim menggunakan KTSP atau kurikulum 2013 mencakup bidang pengembangan nilai agama dan moral, bahasa, fisik motorik, kognitif, dan sosial emosional. Kurikulum KB Al Muslim dikembangkan sebagai perwujudan dari kurikulum pendidikan anak usia dini serta tuntutan pengembangan KB Al Muslim dalam menghadapai persaingan kemampuan lulusan dan kemajuan Ilmu Pengetahuan dan Teknologi agar lulusan KB Al Muslim mampu bersaing secara global dalam bermasyarakat dan bernegara. Terpilihnya KB Al Muslim sebagai sekolah penggerak menjadi tantangan bagi sekolah untuk menerapakan kurikulum sekolah penggerak yang bertujuan untuk meuwujdkan Profil Pelajar Pancasila sebagai implementasi dari visi pendidikan nasional.</div>
                          <p></p>
                         <div class="paragraf" style="text-align: justify; color:#003366;">Layanan pendidikan di KB Al Muslim menggunakan prinsip yang digunakan dalam proses pembelajaran anak usia dini sebagai berikut:</div>
                          ...
                          <div class="paragraf" style="text-align: justify; color:#003366; margin-left: 15px;">i.) Pemanfaatan media belajar, sumber belajar, dan narasumber yang ada di lingkungan KB Al Muslim</div>
                    </div>
                </div>
            </div>
             ...
             <div class="row">
                <div class="col-12 col-sm-80">
                    <div class="single-team-member-area mb-100">
                          ...
                          <div class="paragraf" style="text-align: justify; color:#003366;">Kurikulum khas KB Al Muslim mengedepankan pendidikan karakter dalam program pendidikannya. Untuk menunjang program tersebut, maka telah dikembangkan kurikulum yang dapat menumbuh kembangkan karakter positif, yaitu dengan menambahkan mata pelajaran Green Education (GE) dan Leadership.</div>
                    </div>
                </div>
            </div>
